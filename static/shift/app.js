	...
	render : function() {
		...
		if(this.tweetQueue.length<1) { 
			...
			if(this.total>this.MAX_ITEMS) { 
				...
				t8l.message('/main/flyer', JSON.stringify(obj));
	...
	__feedUpdated : function(result) {
		...
		var cc=0;
          ...
          if(cc<4) { 
            ...
            self.tweetQueue.push( '<div style="display:none"><h3>'+out.title+'</h3><div class="desc">'+out.subtitle+'</div><div class="descFull" style="display:none">image</div><img src="'+out.src+'" /></div>' );
          } 
          cc++;
        });
